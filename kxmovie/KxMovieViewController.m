...
- (void)setShowControl:(BOOL)showControl {
  ...
  _topBar.alpha = _showControl ? 1.0 : 0.0;
  _topHUD.hidden = _showControl ? 1.0 : 0.0;;
  _bottomBar.hidden = _showControl ? 1.0 : 0.0;;
}
...
- (void)loadView
{
  ...
  _topHUD.alpha = (_showControl ? 1.0 : 0.0);
  _topBar.alpha = (_showControl ? 1.0 : 0.0);
  _bottomBar.alpha = (_showControl ? 1.0 : 0.0);
